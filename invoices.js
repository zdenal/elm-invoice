...
var _user$project$Invoices$calculateProductTax = function (product) {
	return _user$project$Invoices$calculateProductPriceTotal(product) * (product.tax / 100);
};
var _user$project$Invoices$calculateProductTotal = function (product) {
	return _user$project$Invoices$calculateProductPriceTotal(product) + _user$project$Invoices$calculateProductTax(product);
};
var _user$project$Invoices$viewSummary = function (model) {
	var total = A2(
		_myrho$elm_round$Round$round,
		2,
		_elm_lang$core$List$sum(
			A2(_elm_lang$core$List$map, _user$project$Invoices$calculateProductTotal, model.products)));
	var taxTotal = A2(
		_myrho$elm_round$Round$round,
		2,
		_elm_lang$core$List$sum(
			A2(_elm_lang$core$List$map, _user$project$Invoices$calculateProductTax, model.products)));
	var priceTotal = A2(
		_myrho$elm_round$Round$round,
		2,
		_elm_lang$core$List$sum(
			A2(_elm_lang$core$List$map, _user$project$Invoices$calculateProductPriceTotal, model.products)));
	var unitTotal = _elm_lang$core$Basics$toString(
		_elm_lang$core$List$sum(
			A2(
				_elm_lang$core$List$map,
				function (_) {
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('table table-bordered table-condensed'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('text-center col-xs-1'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Unit Total'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Tax Total'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Price Total'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('text-center rowtotal mono'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(unitTotal),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(taxTotal),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text(priceTotal),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
...
var _user$project$Invoices$Product = F6(
	function (a, b, c, d, e, f) {
		return {id: a, item: b, unit: c, tax: d, price: e, total: f};
	});
var _user$project$Invoices$createProduct = function (id) {
	return A6(_user$project$Invoices$Product, id, '', 1, 21, 0.0, 0.0);
};
var _user$project$Invoices$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'AddProduct':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						products: A2(
							...
							{
								ctor: '::',
								_0: _user$project$Invoices$createProduct(
									_elm_lang$core$List$length(model.products)),
								_1: {ctor: '[]'}
							})
					});
			case 'ChangeUnit':
				var changeUnit = function (product) {
					return _elm_lang$core$Native_Utils.eq(product.id, _p0._0) ? _elm_lang$core$Native_Utils.update(
						product,
						{
							unit: A2(
			...
			case 'ChangeTax':
				...
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						products: A2(_elm_lang$core$List$map, changeTax, model.products)
					});
			default:
				var changePrice = function (product) {
					return _elm_lang$core$Native_Utils.eq(product.id, _p0._0) ? _elm_lang$core$Native_Utils.update(
						product,
						{
							price: A2(
				...
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						products: A2(_elm_lang$core$List$map, changePrice, model.products)
					});
		}
	});
var _user$project$Invoices$Model = F2(
	function (a, b) {
		return {total: a, products: b};
	});
var _user$project$Invoices$initModel = A2(
	_user$project$Invoices$Model,
	0,
	{ctor: '[]'});
var _user$project$Invoices$ChangePrice = F2(
	function (a, b) {
		return {ctor: 'ChangePrice', _0: a, _1: b};
	});
var _user$project$Invoices$ChangeTax = F2(
	function (a, b) {
		return {ctor: 'ChangeTax', _0: a, _1: b};
	});
var _user$project$Invoices$ChangeUnit = F2(
	function (a, b) {
		return {ctor: 'ChangeUnit', _0: a, _1: b};
	});
var _user$project$Invoices$viewProduct = function (product) {
	return A2(
		_elm_lang$html$Html$tr,
		{
			ctor: '::',
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$placeholder('Name of product'),
								_1: {ctor: '[]'}
							},
							{ctor: '[]'}),
						_1: {ctor: '[]'}
							...
							_0: A2(
								_elm_lang$html$Html$input,
								{
									...
									_0: _elm_lang$html$Html_Attributes$value(
										_elm_lang$core$Basics$toString(product.unit)),
									_1: {
										ctor: '::',
										...
										_1: {
											...
											_0: _elm_lang$html$Html_Events$onInput(
												_user$project$Invoices$ChangeUnit(product.id)),
											_1: {ctor: '[]'}
										}
									}
								},
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									_elm_lang$html$Html$input,
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(
											_elm_lang$core$Basics$toString(product.tax)),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$type_('number'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(
													_user$project$Invoices$ChangeTax(product.id)),
												_1: {ctor: '[]'}
											}
										}
									},
										...
										_elm_lang$html$Html$input,
										{
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onInput(
														_user$project$Invoices$ChangePrice(product.id)),
													_1: {ctor: '[]'}
												}
											}
										},
									...
									{ctor: '[]'},
									{
										...
										_0: _elm_lang$html$Html$text(
											_elm_lang$core$Basics$toString(
												_user$project$Invoices$calculateProductTotal(product))),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
...
var _user$project$Invoices$AddProduct = {ctor: 'AddProduct'};
var _user$project$Invoices$viewProducts = function (products) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('panel-default'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Services / Products'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
					...
					},
					{
						...
						_0: A2(
							...
							A2(
												...
												_1: {
													...
													_1: {
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('Tax'),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
								...
								A2(_elm_lang$core$List$map, _user$project$Invoices$viewProduct, products))),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$Invoices$AddProduct),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('btn btn-primary btn-lg btn-block'),
								_1: {ctor: '[]'}
							}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Add a product'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Invoices$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$Invoices$viewProducts(model.products),
			_1: {
				ctor: '::',
				_0: A2(
				...
				_1: {
					ctor: '::',
					_0: _user$project$Invoices$viewSummary(model),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$Invoices$main = _elm_lang$html$Html$beginnerProgram(
	{model: _user$project$Invoices$initModel, view: _user$project$Invoices$view, update: _user$project$Invoices$update})();

var Elm = {};
Elm['Invoices'] = Elm['Invoices'] || {};
if (typeof _user$project$Invoices$main !== 'undefined') {
    _user$project$Invoices$main(Elm['Invoices'], 'Invoices', undefined);
}
